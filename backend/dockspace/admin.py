"""
Module: admin.py
Purpose: Django admin interface customizations for Dockspace models

Provides enhanced admin interfaces for managing mail accounts, aliases, quotas, groups,
and client access controls. Includes custom forms for password management, TOTP setup,
and profile picture handling.

Key Components:
- MailAccountAdmin: Comprehensive admin for mail accounts with inline editing
- MailAliasAdmin: Simple admin for email alias management
- MailQuotaAdmin: Admin for managing mailbox quotas
- MailGroupAdmin: Admin for user group management
- ClientAccessAdmin: Admin for OIDC client access control
"""
import base64
...
from dockspace.core.models import ClientAccess, MailAccount, MailAlias, MailGroup, MailQuota
