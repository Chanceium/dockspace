...
watch(() => props.isOpen, (isOpen) => {
  if (isOpen && props.account && props.mode === 'edit') {
  ...
  if (isOpen && !passwordRequirements.value.length) {
    ...
    <VCard>
      ...
      <VCardText class="pa-6">
        ...
        <VRow>
          ...
          <VCol v-if="showPasswordField" cols="12">
            <VRow class="align-center">
              ...
              <VCol cols="12" md="4" class="d-flex align-start justify-end gap-2">
                <VBtn
                  color="primary"
                  variant="outlined"
                  class="w-100"
                ...
                <span
                  ...
                  :class="[
                    'text-caption',
                    copyState === 'copied' ? 'text-success' : 'text-error',
                  ]"
                >
